...
#
# Self extracting mechanism based on: 
# http://www.noah.org/wiki/Self-extracting_Python_Script
# http://code.activestate.com/recipes/497000/
# http://placidrage.github.io/kb/development/languages/python/1-cbp/1-packages/index.html#python-executable-zip-files
#
# Bourne shell loader:
